...
## It tails the journal and syslog and turns SSH logins, sudo activity, failed services, firewall/network blocks, kernel warnings, system anomalies, and USB events into a structured, severity-scored list stored locally in SQLite and shown in a live dashboard. A simple, smart way to monitor your system and catch issues early—no browser required.
